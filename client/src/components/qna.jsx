      ...
      <div className="container text-right text-white">
        ...
        <div className="row">
          <div className="col-12">
              <br />
              <button className="btn btn-warning m-3" disabled={this.state.favs.length === 0} 
                      onClick={ !this.state.favsViewFlag ? this.showFavs : this.hideFavs }>מועדפים</button>
              <Link className="btn btn-warning" to="/create-card">שלח שאלה חדשה</Link>
          </div>
        </div>
        <SearchCard cards={cards} favs={favs}  onHandleFavs={this.onHandleFavs}/>
        <div className="row">
